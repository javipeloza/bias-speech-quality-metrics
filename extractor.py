...
# Prompt user to select a folder containing audio files
audio_folder = filedialog.askdirectory(title="Select Folder Containing Audio Files")  # Get folder path

# Create a new directory for exported audio chunks
output_dir = os.path.join(audio_folder, "separated_sentences")  # New directory for sentences
